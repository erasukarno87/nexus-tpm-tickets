...
-- Fix the ticket number generation function to avoid FOR UPDATE with aggregate functions
...
BEGIN
  ...
  LOOP
    -- Get the next sequence number for today (without FOR UPDATE on aggregate)
